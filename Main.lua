...
InfoSection:NewLabel("Welcome to FloppaHub - Tower of hell")
...
MainSection:NewSlider("FlightSpeed", "Adjust your flying speed", 500, 0, function(s) 
    FLYSPEED = s
end)
